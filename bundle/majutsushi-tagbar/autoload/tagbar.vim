...
function! s:InitTypes()
    ...
    " MMIX {{{3
    let type_mmix = s:TypeInfo.New()
    let type_mmix.ctagstype = 'asm'
    let type_mmix.kinds     = [
        \ {'short' : 'd', 'long' : 'defines',   'fold' : 0, 'stl' : 1},
        \ {'short' : 'l', 'long' : 'labels',    'fold' : 0, 'stl' : 1},
        \ {'short' : 'v', 'long' : 'variables', 'fold' : 0, 'stl' : 1},
        \ {'short' : 'f', 'long' : 'functions', 'fold' : 0, 'stl' : 1}
    \ ]
    let s:known_types.mmix = type_mmix
    " Ocaml {{{3
    ...
    " CWeb {{{3
    let type_cweb = s:TypeInfo.New()
    let type_cweb.ctagstype = 'tex'
    let type_cweb.kinds     = [
        \ {'short' : 'i', 'long' : 'includes',       'fold' : 1, 'stl' : 0},
        \ {'short' : 'p', 'long' : 'parts',          'fold' : 0, 'stl' : 1},
        \ {'short' : 'c', 'long' : 'chapters',       'fold' : 0, 'stl' : 1},
    ...
    let type_cweb.scope2kind = {
        ...
        \ 'subsubsection' : 'b'
    \ }
    let type_cweb.sort = 0
    let s:known_types.cweb = type_cweb
    " YACC {{{3
